                                    ...
                                    <div class="col-12">
                                        <a class="image img_cover_obf" href="<?php the_permalink(); ?>" style="width: 310px;px; height: 165px;">
                                            <?php if (has_post_thumbnail()) : ?>
                                                ...
                                                <img style="object-fit: cover; height: 100% !important" width="500" height="325" src="<?php echo get_featured_image_guid($id); ?>" class="card-img wp-post-image" alt="<?php the_title(); ?>" decoding="async" title="<?php the_title(); ?>" data-lazy-src="<?php echo get_featured_image_guid($id); ?>" />
