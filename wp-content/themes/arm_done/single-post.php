...
?>
                    ...
                    <article class="news-detail post-detail">
                        <nav class="vsc-breadcrumb vsc-breadcrumb-border" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <?php if ($term) : ?>
                                    <?php
                                    // Lặp qua tất cả các chuyên mục và hiển thị tên của chúng lấy chuyên mục
    ...
    <section class="section related-news">
        <div class="block-heading">
            <div class="h2 the-title font-weight-bold mb-0" style="font-family: sans-serif;">
                    ...
                    <div class="slider-item same-height-item">
                        <article class="card bg-brown vsc-news-card vsc-related-news">
                            <a href="<?php the_permalink(); ?>">
                                ...
                                <?php else : ?>
                                    <img width="500" height="325" class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/assets/img/default-image.jpg" alt="Ảnh mặc định">
                                <?php endif; ?>
                            </a>
                            <div class="card-body">
